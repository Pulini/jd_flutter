...
import com.jd.pzx.jd_flutter.utils.bluetoothInit
import com.jd.pzx.jd_flutter.utils.bluetoothIsEnable
import com.jd.pzx.jd_flutter.utils.checkBluetooth
...
//                    }
                    "IsEnable" -> bluetoothIsEnable(this)
//                    "GetScannedDevices" -> {
//                        devices.forEach { device ->
//                            HashMap<String, Any>().let {
//                                it["DeviceName"] = device.name
...
//                    }
                    ...
                    "CheckBluetooth" -> ActivityCompat.requestPermissions(
                        activity,
                        arrayOf(
...
//    }
    ...
    override fun onRequestPermissionsResult(
        ...
        when (requestCode) {
            REQUEST_BLUETOOTH_PERMISSIONS -> {
                if (grantResults.filter { it == PackageManager.PERMISSION_GRANTED }.size == permissions.size) {
