...
import 'package:jd_flutter/fun/warehouse/manage/new_carton_label_scan/new_carton_label_scan_logic.dart';
import 'package:jd_flutter/fun/warehouse/manage/new_carton_label_scan/new_carton_label_scan_state.dart';
import 'package:jd_flutter/widget/custom_widget.dart';

class NewCartonLabelScanProgressDetailView extends StatefulWidget {
  const NewCartonLabelScanProgressDetailView({super.key});

  @override
  State<NewCartonLabelScanProgressDetailView> createState() =>
      _NewCartonLabelScanProgressDetailViewState();
}

class _NewCartonLabelScanProgressDetailViewState
    extends State<NewCartonLabelScanProgressDetailView> {
