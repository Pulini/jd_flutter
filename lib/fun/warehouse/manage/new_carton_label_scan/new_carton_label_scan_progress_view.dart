...
class NewCartonLabelScanProgressPage extends StatefulWidget {
  const NewCartonLabelScanProgressPage({super.key});

  @override
  State<NewCartonLabelScanProgressPage> createState() =>
      _NewCartonLabelScanProgressPageState();
}

class _NewCartonLabelScanProgressPageState
    extends State<NewCartonLabelScanProgressPage> {
