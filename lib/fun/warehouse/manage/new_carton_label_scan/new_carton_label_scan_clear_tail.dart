...
import 'new_carton_label_scan_clear_tail_detail.dart';
import 'new_carton_label_scan_logic.dart';
import 'new_carton_label_scan_state.dart';

class NewCartonLabelScanClearTail extends StatefulWidget {
  const NewCartonLabelScanClearTail({super.key});

  @override
  State<NewCartonLabelScanClearTail> createState() =>
      _NewCartonLabelScanClearTailState();
}

class _NewCartonLabelScanClearTailState extends State<NewCartonLabelScanClearTail> {
            ...
            child: InkWell(
              onTap: () {
                logic.setTailDetail(
                    index: position,
                    goActivity: () {
                      Get.to(() => const NewCartonLabelScanClearTailDetailPage())
                          ?.then((v) {
                        if (v == true) {
