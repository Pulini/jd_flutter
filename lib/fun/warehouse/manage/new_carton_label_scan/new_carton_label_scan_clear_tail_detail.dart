...
class NewCartonLabelScanClearTailDetailPage extends StatefulWidget {
  const NewCartonLabelScanClearTailDetailPage({super.key});

  @override
  State<NewCartonLabelScanClearTailDetailPage> createState() =>
      _NewCartonLabelScanClearTailDetailPageState();
}

class _NewCartonLabelScanClearTailDetailPageState
    extends State<NewCartonLabelScanClearTailDetailPage> {
