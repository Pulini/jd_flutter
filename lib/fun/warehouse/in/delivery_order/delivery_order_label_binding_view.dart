...
class _DeliveryOrderLabelBindingPageState
  ...
  Widget _item(DeliveryOrderPieceInfo data) {
    return Container(
    ...
    return pageBody(
      ...
      actions: [
        TextButton(
          onPressed: () => askDialog(
            content: '确定要清空已扫描钱吗？',
            confirm: () => state.scannedLabel.clear(),
          ),
          child: Text('清空'),
        )
      ],
        ...
        children: [
          ...
          Expanded(
            child: Obx(() => ListView.builder(
                  itemCount: state.scannedLabel.length,
                  itemBuilder: (c, i) => _item(state.scannedLabel[i]),
                )),
          ),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Obx(() => textSpan(
                      hint: '已扫描：',
                      text: state.scannedLabel.length.toString(),
                    )),
                textSpan(
                  hint: '送货单号：',
                  text: state.orderItemInfo[0].factoryNO ?? '',
            ...
            children: [
              Expanded(
                child: Obx(() => CombinationButton(
                      ...
                      isEnabled: state.scannedLabel.isNotEmpty,
                      text: '暂存',
