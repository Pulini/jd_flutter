...
class OrderExceptionClosePage extends StatefulWidget {
  const OrderExceptionClosePage({super.key});

  @override
  State<OrderExceptionClosePage> createState() =>
      _OrderExceptionClosePageState();
}

class _OrderExceptionClosePageState extends State<OrderExceptionClosePage> {
  ...
  Widget build(BuildContext context) {
    return pageBody(
      title: 'incoming_inspection_order_disposed_exception'.tr,
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(
          ...
          SizedBox(
            ...
            child: CombinationButton(
              text: 'incoming_inspection_order_close_case'.tr,
              click: () => askDialog(
                content: 'incoming_inspection_order_close_tips'.tr,
                confirm: () => logic.submitCloseOrder(),
              ),
            ),
          )
        ],
