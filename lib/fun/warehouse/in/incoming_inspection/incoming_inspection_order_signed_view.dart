...
class OrderSignedPage extends StatefulWidget {
  const OrderSignedPage({super.key});

  @override
  State<OrderSignedPage> createState() => _OrderSignedPageState();
}

class _OrderSignedPageState extends State<OrderSignedPage> {
  ...
  Widget build(BuildContext context) {
    return pageBody(
      title: 'incoming_inspection_order_signed'.tr,
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                textSpan(
                  hint: 'incoming_inspection_order_sign_info'.tr,
                  text:
                      '${state.inspectionDetail?.checkerDate} ${state.inspectionDetail?.checker}',
                  textColor: Colors.black54,
                ),
              ],
            ),
