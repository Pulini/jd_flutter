...
class _PurchaseOrderWarehousingPageState
  ...
  Widget _item(PurchaseOrderInfo data) => _PurchaseOrderWarehousingItem(
        data: data,
        logic: logic,
...
class _PurchaseOrderWarehousingItem extends StatelessWidget {
  final PurchaseOrderInfo data;
  final PurchaseOrderWarehousingLogic logic;
  final TextEditingController distributionController;

  const _PurchaseOrderWarehousingItem({
    required this.data,
    required this.logic,
