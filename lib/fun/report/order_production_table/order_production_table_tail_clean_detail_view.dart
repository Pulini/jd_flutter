...
class OrderProductionTableTailCleanDetailPage extends StatefulWidget {
  const OrderProductionTableTailCleanDetailPage({super.key});

  @override
  State<OrderProductionTableTailCleanDetailPage> createState() =>
      _NewCartonLabelScanClearTailDetailPageState();
}

class _NewCartonLabelScanClearTailDetailPageState
    extends State<OrderProductionTableTailCleanDetailPage> {
