...
import 'order_production_table_logic.dart';
import 'order_production_table_state.dart';
import 'order_production_table_tail_clean_detail_view.dart';

class OrderProductionTableTailCleanPage extends StatefulWidget {
  const OrderProductionTableTailCleanPage({super.key});

  @override
  State<OrderProductionTableTailCleanPage> createState() =>
      _NewCartonLabelScanClearTailState();
}

class _NewCartonLabelScanClearTailState extends State<OrderProductionTableTailCleanPage> {
            ...
            child: InkWell(
              onTap: () {
                logic.setTailDetail(
                    index: position,
                    goActivity: () {
                      Get.to(() => const OrderProductionTableTailCleanDetailPage())
                          ?.then((v) {
                        if (v == true) {
