...
class Translation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        localeChinese.toString(): {
          ...
          'process_report_manual_input': '手动录入条码',
          'process_report_hava_barcode': '条码已存在',
          'process_report_use_empty_pallets': '请使用空托盘入库!',
          'process_report_used_pallets': '此托盘已在其他仓库使用!',
          'process_report_not_reported': '未汇报',
          'process_report_submit_process_store': '提交工序汇报入库',
          'process_report_input_operator_id': '请输入操作人工号',
          'process_report_process_procedure': '制程/工序：',
          'process_report_select_process_procedure': '请选择制程和工序：',
          'process_report_submit': '提交',
          'process_report_verifying_tags': '正在校验条码...',
          'process_report_no_barcode': '无条码可提交!',
          'process_report_obtaining_summary_information': '正在获取汇总信息...',
          'process_report_submitting_process_store': '正在提交工序汇报入库...',
          'process_report_delete_failed': '本地数据库贴标删除失败!',
          'process_report_change': '修改',
          'process_report_historical_records': '历史记录',
          'process_report_clear_list': '清空列表',
          'process_report_sure_clean_code': '确定要清除条码吗？',
          'process_report_manually_add': '手动添加',
          'process_report_submit_barcode': '提交',
          'process_report_modify_clear': '清空',
          'process_report_modify_modify': '修改',
          'process_report_modify_barCode': '条形码',
          'process_report_modify_size': '尺码',
          'process_report_modify_original_quantity': '原数量',
          'process_report_modify_real_number': '实数',
          'process_report_modify_reading_database': '正在读取数据库...',
          'process_report_modify_input_real_number': '请输入实数',
          'process_report_modify_submit': '确定提交修改吗?',
          'process_report_modify_scan_real_barcode': '请扫描正确的条码?',
        ...
        localeEnglish.toString(): {
          ...
          'process_report_manual_input': 'Manually enter barcode',
          'process_report_hava_barcode': 'Barcode already exists!',
          'process_report_use_empty_pallets': 'Please use empty pallets for storage!',
          'process_report_used_pallets': 'This pallet is already in use in another warehouse!',
          'process_report_submit_process_store': 'Submit process report for storage',
          'process_report_input_operator_id': 'Please enter the operator number',
          'process_report_process_procedure': 'Process/procedure：',
          'process_report_select_process_procedure': 'Please select process and procedure：',
          'process_report_submit': 'Submit',
          'process_report_verifying_tags': 'Verifying barcode...',
          'process_report_no_barcode': 'No barcode available for submission!',
          'process_report_obtaining_summary_information': 'Obtaining summary information...',
          'process_report_submitting_process_store': 'Submitting process report for storage...',
          'process_report_delete_failed': 'Local database label deletion failed!',
          'process_report_change': 'Change',
          'process_report_historical_records': 'Historical Records',
          'process_report_clear_list': 'Clear List',
          'process_report_sure_clean_code': 'Are you sure you want to clear the barcode？',
          'process_report_manually_add': 'Manually add',
          'process_report_submit_barcode': 'Submit',
          'process_report_modify_clear': 'Clear',
          'process_report_modify_modify': 'Modify',
          'process_report_modify_barCode': 'BarCode',
          'process_report_modify_size': 'Size',
          'process_report_modify_original_quantity': 'Original quantity',
          'process_report_modify_real_number': 'Real number',
          'process_report_modify_reading_database': 'Reading database...',
          'process_report_modify_input_real_number': 'Please enter a real number',
          'process_report_modify_submit': 'Are you sure to submit the modifications?',
          'process_report_modify_scan_real_barcode': 'Please scan the correct barcode?',
