...
class Translation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        localeChinese.toString(): {
          ...
          'quality_inspection_short_quantity': '短码数',
          'quality_inspection_qualified_quantity': '合格数',
          'quality_inspection_inventory_quantity': '入库数',
          ...
          'carton_label_binding_error_tips': '标签供应商、工厂、物料大类、保管形式、单据类型不同，不能同时操作！',
          ...
          'carton_label_binding_label_binding_new_piece_tips': '确定要将所有标签合并绑定到全新的外箱标上吗?',
          'carton_label_binding_label_binding_tips': '确定要将所有标签绑定到件号<%s>的外箱标上吗？',
          'carton_label_binding_label_unbind_tips': '确定要将件号<%s>中的所有标签解绑吗？',
          'carton_label_binding_label_transfer_tips': '确定要将所有标签转移到件号<%s>的外箱标上吗？',
        ...
        localeEnglish.toString(): {
          ...
          'carton_label_binding_delete_label_tips': 'Are you sure you want to delete the label？',
          'carton_label_binding_out_box_label_piece_no': 'Outer box label piece no：',
          ...
          'carton_label_binding_error_tips': 'Label suppliers, factories, material categories, storage methods, and document types are different and cannot be operated simultaneously!',
          ...
          'carton_label_binding_print_out_box_label_tips': 'Do you want to print a new outer box label ？',
          ...
          'carton_label_binding_label_binding_new_piece_tips': 'Are you sure you want to merge and bind all labels to a brand new outer box label ?',
          'carton_label_binding_label_binding_tips': 'Are you sure you want to bind all labels to the outer box label of part number<%s>?',
          'carton_label_binding_label_unbind_tips': 'Are you sure you want to unbind all tags in part number<% s>?',
          'carton_label_binding_label_transfer_tips': 'Are you sure you want to transfer all labels to the outer box label with part number<% s>?',
          ...
          'carton_label_binding_data_not_input_tips': 'The trade factory label must be filled with length, width, height, and outer packaging weight !',
        }
      };
}
