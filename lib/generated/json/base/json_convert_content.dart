...
class JsonConvert {
	static final Map<String, JsonConvertFunction> convertFuncMap = {
		(BluetoothEntity).toString(): BluetoothEntity.fromJson,
...
List<T>? convertListNotNull<T>(dynamic value, {EnumConvertFunction? enumConvert}) {
  ...
  T? _asT<T extends Object?>(dynamic value,
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		if(<BluetoothEntity>[] is M){
			return data.map<BluetoothEntity>((Map<String, dynamic> e) => BluetoothEntity.fromJson(e)).toList() as M;
		}
		if(<UserAvatarEntity>[] is M){
			return data.map<UserAvatarEntity>((Map<String, dynamic> e) => UserAvatarEntity.fromJson(e)).toList() as M;
		}
		if(<DepartmentEntity>[] is M){
			return data.map<DepartmentEntity>((Map<String, dynamic> e) => DepartmentEntity.fromJson(e)).toList() as M;
		}
		if(<GroupEntity>[] is M){
