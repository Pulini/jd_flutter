    ...
    if (<UserAvatarEntity>[] is M) {
      return data
          .map<UserAvatarEntity>(
              (Map<String, dynamic> e) => UserAvatarEntity.fromJson(e))
          .toList() as M;
    }
    if (<DepartmentEntity>[] is M) {
      return data
          .map<DepartmentEntity>(
              (Map<String, dynamic> e) => DepartmentEntity.fromJson(e))
          .toList() as M;
    }
    if (<GroupEntity>[] is M) {
      return data
          .map<GroupEntity>((Map<String, dynamic> e) => GroupEntity.fromJson(e))
          .toList() as M;
    }
