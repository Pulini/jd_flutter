...
class BluetoothUtil: NSObject {
    var tscUUID="00001101-0000-1000-8000-00805F9B34FB"
    private let BLE_WRITE_UUID = "xxxx"
    private let BLE_NOTIFY_UUID = "xxxx"
    
    static let shared = BluetoothUtil()
...
extension BluetoothUtil:CBCentralManagerDelegate {
...
extension BluetoothUtil: CBPeripheralDelegate {
    //MARK: 匹配对应服务UUID
